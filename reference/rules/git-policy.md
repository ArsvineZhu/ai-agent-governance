...
修改 `AGENTS.md`、`docs/rules/**`、`.agent/manifest.json`、`.agent/preflight.json`、`scripts/verify-governance.js`、CI 配置需要特殊权限：
说明原因 → 更新 CHANGELOG → **更新 `.agent/manifest.json` 的 `governance_version`** → 运行 `scripts/verify-governance.js`。
