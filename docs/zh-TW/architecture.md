...
│   │   ├── sub-skills.md           # 8 個生成的 Agent 模組（repository-inspection、ci-generator、governance-validator、state-manager、drift-check、release-manager、plan-manager、review-manager）
