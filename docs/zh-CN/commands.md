...
| review-manager | 轻量：`review this` · `review the changes` · `audit recent changes` · `review my changes` · `审核一下` — 全量：`deep review` · `full review` · `audit everything` · `全面审查` · `彻底审查` · `逐行审查` | 变更集评审，双模式（轻量 / 全量） |
